                ...
                <div class="col-md-7">
                    <div class="feature_article_wrapper">
                        ...
                        <div class="feature_article_inner">
                            ...
                            <div class="feature_article_date"><a href="#" target="_self">id: {{$articles[0]->id}}</a>,{{$articles[0]->created_at}}</div>
                ...
                @foreach ($articles as $article)           
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            </h3> <span class="media-date">{{$article->created_at}},  id: <a href="#">{{$article->id}}</a></span>
                            ...
                            <div class="widget_article_social">
                                ...
                                <a href="{{ route('edit',["id"=>$article->id]) }}" class="btn btn-primary">edit</a>
                            </div>
                        </div>
                    </div>
                @endforeach
